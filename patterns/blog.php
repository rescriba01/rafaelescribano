...
<h2 class="wp-block-heading"><?php echo __('Blog', 're'); ?></h2>
<!-- /wp:heading -->
...
<p class="has-secondary-color has-text-color has-link-color has-small-font-size"><?php echo __('No posts', 're'); ?></p>
<!-- /wp:paragraph -->
